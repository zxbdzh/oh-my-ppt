...
export const en = {
  ...
  settings: {
    ...
    externalAgentSection: 'Local agent access',
    externalAgentHint:
      'External agents connect through the local MCP Bridge. First connection asks for approval; revoke access here at any time.',
    externalAgentCommandLabel: 'MCP launch command',
    externalAgentCommandHint:
      'Put this command in the pi / Codex MCP config. The app must already be running.',
    externalAgentEmpty: 'No authorized external agents yet.',
    externalAgentConnected: 'Authorized',
    ...
    externalAgentCreatedAt: 'Created',
